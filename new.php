                ...
                <div class="col-sm-12 col-lg-12">
                    <div class="card">
                        ...
                        <div class="header-title">
                            <h4 class="card-title">Home Loan Form For Salaried Person</h4>
                        </div>
                        </div>
                        <div class="card-body">
                        <form id="form-wizard1" class="mt-3 text-center">
                                ...
                                <div class="form-card text-start">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="uname" placeholder="Occupation" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="form-card text-start">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Salary Slip (1 month) :</label>
                                            <input type="file" class="form-control" name="pic-4" accept="image/*">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Salary Slip (2 month):</label>
                                            <input type="file" class="form-control" name="pic-5" accept="image/*">
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label class="form-label">Salary Slip (3 month):</label>
