                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <label class="form-check-label" for="exampleRadio1">WITHDRAW</label></td>
                                    <td><input type="radio" name="radios" class="form-check-input" id="exampleRadio2">
                                    <label class="form-check-label" for="exampleRadio1">BALANCE ENQUIRY</label></td>
                                    <td><input type="radio" name="radios" class="form-check-input" id="exampleRadio3">
                                    <label class="form-check-label" for="exampleRadio1">MINI STATEMENT</label></td>
                       ...
                       <!-- <div class="bd-example">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <label class="form-check-label" for="exampleRadio1">Mantra</label></td>
                                <td><input type="radio" name="radios" class="form-check-input" id="exampleRadio1b">
                                <label class="form-check-label" for="exampleRadio1">Morpho</label></td>
                                <td><input type="radio" name="radios" class="form-check-input" id="exampleRadio1c">
                                <label class="form-check-label" for="exampleRadio1">Startek</label></td>
