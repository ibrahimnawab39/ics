    ...
    <div class="row">
                ...
                <div class="card-body">
                    <form>
                        <div class="form-group">
                            ...
                            <option value="2">INDIA POWER</option>
                            <option value="3">MPEB</option>
                            </select>
                        </div>
                        ...
                        <div class="form-group">
                            <label class="form-label" for="pwd">Cycle/Unit/Installation No:</label>
                            <input type="text" class="form-control" id="pwd">
                        </div>

                        
                        <div class="form-group">
                            <label class="form-label" for="pwd">Due Date:</label>
                            <input type="text" class="form-control" id="pwd">
                        </div>
        ...
        <div class="col-sm-12 col-lg-6">
            <div class="card">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title">Electricity COMMENT</h4>
                    </div>
                </div>
                <div class="card-body">
                    <form>
